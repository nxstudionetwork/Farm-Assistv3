"""Official Indian State/UT and District master list (static reference data).

This is legitimate static reference geography used to power the Market Prices
location filters (State/UT -> District -> Market/Mandi). It mirrors the LGD /
administrative district master published by the Government of India and is
*not* market price data. Actual prices always come from the configured real
data source; these names are only used to let every State/UT and district be
selected even before data exists for it.
"""

# 28 States + 8 Union Territories, ordered by conventional listing.
STATES_UTS = [
...
STATE_DISTRICTS = {
    ...
    "Punjab": [
        ...
        "Patiala", "Rupnagar", "Sangrur", "SAS Nagar", "Shaheed Bhagat Singh Nagar",
    ...
    "Rajasthan": [
        ...
        "Jhalawar", "Jhunjhunu", "Jodhpur", "Karauli", "Kekri",
    ...
    "Uttar Pradesh": [
        ...
        "Shamli", "Shravasti", "Siddharth Nagar", "Sitapur", "Sonbhadra",
    ...
    "Jammu and Kashmir": [
        ...
        "Jammu", "Kathua", "Kishtwar", "Kulgam", "Kupwara", "Pulwama", "Poonch",
